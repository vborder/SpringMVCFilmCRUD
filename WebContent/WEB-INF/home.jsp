...
<br><br>
	...
	<FORM action="addFilm.do" method="POST">
		<P>
			...
			<LABEL for="release_year">Release year: </LABEL> <INPUT type="number" min="1950" max="2020"
				id="release_year" placeholder="Enter Release Year"
				name="releaseYear" style="width: 15em" required><BR>
