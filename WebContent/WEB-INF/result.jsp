...
>>>>>>> af79241ef1947180e35f54a51e615098f848d567
	...
	<FORM action="EditFilm.do" method="post">
		<P>
			...
			<LABEL for="releaseYear">Release year ${film.releaseYear }
			</LABEL> <INPUT type="text" id="releaseYear"><BR> <LABEL
				for="languageId">Language numeric ID ${film.languageId } </LABEL>
			<INPUT type="text" id="languageId"><BR> <LABEL
			...
			<LABEL for="rating">Movie rating ${film.rating } </LABEL> <INPUT
				...
				for="specialFeatures">Special features
				{film.specialFeatures </LABEL> <INPUT type="text" id="specialFeatures"><BR>
